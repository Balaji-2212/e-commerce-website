...
end_header_idx = sched.find('<!-- CONTENT -->')
if end_header_idx != -1:
    new_html = sched[:end_header_idx]
    
    new_html = new_html.replace('<title>My Schedule · Srijes</title>', '<title>Client Records · Srijes</title>')
    new_html = new_html.replace('class="nav-item ripple active" onclick="window.location.href=\'schedule.html\'"', 'class="nav-item ripple" onclick="window.location.href=\'schedule.html\'"')
    new_html = new_html.replace('<span class="nav-dot"></span>', '')
    new_html = new_html.replace('class="nav-item ripple" onclick="window.location.href=\'clients.html\'"', 'class="nav-item ripple active" onclick="window.location.href=\'clients.html\'"')
    new_html = new_html.replace('<span class="nav-icon">👥</span> Client Records', '<span class="nav-icon">👥</span> Client Records\n        <span class="nav-dot"></span>')
